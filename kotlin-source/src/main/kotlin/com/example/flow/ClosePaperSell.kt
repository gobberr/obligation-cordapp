...
@SchedulableFlow
@StartableByRPC
class ClosePaperSell(val AuctionReference: String) : FlowLogic<SignedTransaction>() {
    ...
    override fun call(): SignedTransaction {
        ...
        // Get the Sell state corresponding to the provided ID from our vault.
        ...
        val endAuctionCommand = Command(PaperContract.End(), auctionState.itemOwner.owningKey)
