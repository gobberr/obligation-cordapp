 ...
 */
@StartableByRPC
class CreatePaperSell(val itemName: String,
    ...
    override fun call(): SignedTransaction {
        ...
        val newAuction = Sell(itemName,ItemDescription,startPrice,Instant.parse(ExpiryDate),serviceHub.myInfo.legalIdentities.first(), null, 0, true,allAuctionParticipants)
        val startCommand = Command(PaperContract.Start(), listOf(ourIdentity.owningKey))
        val outputState = StateAndContract(newAuction, PaperContract.CONTRACT_REF)
